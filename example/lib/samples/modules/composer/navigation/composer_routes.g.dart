...
extension ComposerRouterNavigation on ComposerRouter {
  ...
  Future<void> toHelp() async {
    return nuvigator?.pushNamed<void>(
      ComposerRoutes.help,
    );
  }

  Future<void> pushReplacementToHelp<TO extends Object?>({TO? result}) async {
  ...
  Future<void> popAndPushToHelp<TO extends Object?>({TO? result}) async {
