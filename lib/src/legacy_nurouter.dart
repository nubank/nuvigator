...
abstract class NuRouter implements INuRouter {
  ...
  NuvigatorState get nuvigator => _nuvigator as NuvigatorState;
  ...
  ScreenRoute? _getScreen(RouteSettings settings) {
    ...
    return screenBuilder(settings)!.wrapWith(screensWrapper) as ScreenRoute?;
  }
  ...
  Future<T?> openDeepLink<T extends Object>(Uri url,
