...
class NuvigatorStateTracker extends NavigatorObserver {
  ...
  NuvigatorState get nuvigator => navigator as NuvigatorState;
...
abstract class INuRouter {
  ...
  Route<T>? getRoute<T extends Object>({
    ...
    this.shouldPopRoot = false,
        ...
        super(
          ...
          onGenerateInitialRoutes: (_, __) {
            ...
            final r = router!.getRoute<Object>(
              deepLink: deepLink!,
...
class NuvigatorState<T extends INuRouter?> extends NavigatorState
  ...
  @override
  _NuvigatorInner get widget => super.widget as _NuvigatorInner;
  ...
  Future<R?> openDeepLink<R extends Object>(Uri deepLink, [dynamic arguments]) {
  ...
  Future<R?> open<R extends Object>(
    ...
    if (route != null) {
      ...
      return router!.onDeepLinkNotFound!(
          router, Uri.parse(deepLink), false, parameters) as Future<R?>;
    } else if (isNested) {
